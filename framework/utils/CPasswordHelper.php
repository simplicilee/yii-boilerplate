 ...
 * environments through the PHP {@link http://php.net/manual/function.crypt.php crypt()}
...
class CPasswordHelper
{
	 ...
	 *
	 * Uses the
	 * PHP {@link http://php.net/manual/function.crypt.php crypt()} built-in function
	 ...
	 *
	 * The PHP {@link http://php.net/manual/function.crypt.php crypt()} built-in function
