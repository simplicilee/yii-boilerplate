...
class CDbCommand extends CComponent
{
	 ...
	 * Since 1.1.7 it is possible to use a specific mode of data fetching by setting
 	 * {@link setFetchMode FetchMode}. See {@link http://www.php.net/manual/function.PDOStatement-setFetchMode.php}
 	 * for more details.
	 */
	 ...
	 * @return static
	 * @see http://www.php.net/manual/function.PDOStatement-setFetchMode.php
	 * @since 1.1.7
	 */
	 ...
	 * @see http://www.php.net/manual/function.PDOStatement-bindParam.php
	 */
	 ...
	 * @param integer $dataType SQL data type of the parameter. If null, the type is determined by the PHP type of the value.
	 * @return static the current command being executed
	 * @see http://www.php.net/manual/function.PDOStatement-bindValue.php
	 */
	 ...
	 * @return integer 0 is always returned. See {@link http://php.net/manual/pdostatement.rowcount.php} for more information.
	 * @since 1.1.6
	 */
