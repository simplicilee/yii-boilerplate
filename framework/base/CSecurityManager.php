...
class CSecurityManager extends CApplicationComponent
{
	 ...
	 * See {@link http://php.net/manual/function.hash-algos.php hash-algos} for the list of possible
	 ...
	 * This will be passed as the first parameter to {@link http://php.net/manual/function.mcrypt-module-open.php mcrypt_module_open}.
	 *
