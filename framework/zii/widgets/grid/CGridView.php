...
class CGridView extends CBaseListView
{
	 ...
	 * please refer to the {@link http://www.php.net/manual/language.expressions.php php manual}.
	 * @see rowCssClass
	...
	/**
	 * @var boolean whether to leverage the {@link https://developer.mozilla.org/DOM/window.history DOM history object}.  Set this property to true
